...
<template>
  <div class="vkeyboard">
    <div class="btn-wrap-mid">
      <el-button
        @click="handleBtnClick('Up')"
        @touchstart.native="handleTouchStart('Up')"
    ...
    <div class="btn-wrap-space">
      <el-button
        ...
        @touchstart.native="handleTouchStart('Left')"
        @touchend.native="handleTouchEnd"
        type="primary">
        左
      </el-button>
      <el-button
        ...
        @touchstart.native="handleTouchStart('Right')"
        @touchend.native="handleTouchEnd"
        type="primary">
        右
      </el-button>
    ...
    <div class="btn-wrap-mid">
      <el-button
        @click="handleBtnClick('Down')"
        @touchstart.native="handleTouchStart('Down')"
        @touchend.native="handleTouchEnd"
        type="primary">
        下
      </el-button>
